...
int main() {
    std::vector<bool> mark = {false, false, false, false, false, true, true, true, true, false, false, false, false, true, false, true, true, false, false, false, false, true, false, true, true, false, true, false, false, true, true, false, true, true, false, false, false, false, true, false, false, true, false, true, false, true, false, false, true, false, false, true, false, false, true, false, true, false, false, true, true, false, false, false, false, true, false, true, false, false, false, true, true, true, false, true, false, true, true, true, true, false, true, true};
    std::vector<bool> mark2 = mark;
    std::vector<uint32_t> keys = {0xf16285bd, 0x4d79b336, 0x3607c041, 0x4f757c48, 0x63634432, 0x8474be64, 0x2f66bfed, 
    ...
    std::cout << "What's the password to the bank vault? ";
    ...
    for (int i = 0; i < keys.size(); i++) {
        curr = mark2.back();
        bool next = static_cast<uint8_t>(keys.at(i) >> 16 & 0xff) == static_cast<uint8_t>(input[len]);
        if (curr) { len++; }
        result.push_back(next);
        mark2.pop_back();
    }

    // it compiles but doesn't pass the checks. Time to debug
